...
void fragDeferred (
	...
	SDFResult r = sampleSurface(d, blendFactors, outline);
	// Supersampling of little use for the outer contour, but could still work for blending between the two contours.
		...
		bool bevel = false;
			...
			bevel = true;
		#endif
		sampleNormal(d, r, blendFactors, outline, bevel);
	#endif
